...
const ResumeLayout = ({ resume, heading, headingIcon }) => {
    return (
        ...
        //         <h3 className=" text-2xl lg:text-[36px] text-white font-bold font-rubik leading-[120%] capitalize  ] "> {heading} </h3>
        //     </div>
        //     {/* heading end.... */}
        ...
        //             <div key={resume.id}
        //                 className="lg:py-7.5 lg:px-5 p-5 mb-5 rounded-[20px] bg-[#141414] ">
        ...
        //                 <h4 className=" my-2 text-lg lg:text-[25px] text-white font-semibold font-rajdhani leading-[120%] capitalize "> {resume.title} </h4>
        //                 <p className=" text-sm lg:text-base text-[#9f9f9f] font-normal font-rajdhani leading-[150%] capitalize   "> {resume.institute} </p>
        //             </div>
        ...
        <Link to="/" className="group cursor-pointer block">
            ...
            {resume?.map((resume) => {
               ...
               " ></span>
                        ...
                        <p className="relative z-20 text-sm lg:text-base text-[#9f9f9f] font-normal font-rajdhani leading-[150%] capitalize">
                            {resume.institute}
                        </p>
                    </div>
                    // single resume container end.....
