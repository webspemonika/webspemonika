...
const HeroSection = () => {
    return (
        <>
            ...
            <section id="hero" className=" bg-[url(/bg-images/nav-hero-bg.jpg)] bg-no-repeat bg-cover bg-center  py-8 lg:pt-20 lg:pb-0 ">
                <div className="container">
                    <div className="mobile-padding grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-20 justify-between items-center   ">
                        ...
                        <div className="lg:col-span-2 w-full lg:w-[80%] order-2 lg:order-1  ">
                            ...
                            <div className="mb-7">
                                <p className="text-base text-[#9f9f9f] font-normal font-rubik leading-8.5 capitalize mb-2.5" > find on me </p>
